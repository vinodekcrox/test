					...
					<table id="list_websites" class="table table-striped table-bordered table-hover no-footer">
						<thead>
							<tr role="row">
								...
								<th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 253px;">Hosting</th>
						...
						<tbody>        
							...
							?>
								<tr class="gradeA <?php echo $rem = (($i%2) == 0) ? 'even' : 'odd'; ?>">
									...
									<td class="center "><a href="<?php echo base_url(); ?>index.php/Hosting/show_hosting/<?php echo $row->id; ?>">Edit</a></td>
									<td class="center "><a href="<?php echo base_url(); ?>index.php/Hosting/delete/<?php echo $row->id; ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
								</tr>
							<?php } ?>
						</tbody>
                    </table>
